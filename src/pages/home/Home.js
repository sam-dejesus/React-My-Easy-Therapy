           ...
           <div>
            {services.map((service, index) => (
              <div className="card" key={index}>
                {/* <img src={service.image} class="card-img-top" alt={service.alt}></img> */}
